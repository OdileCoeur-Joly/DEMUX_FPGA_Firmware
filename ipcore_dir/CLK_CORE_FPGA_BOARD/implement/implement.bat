...
xst -ifn xst.scr
move CLK_CORE_FPGA_BOARD_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK_CORE_FPGA_BOARD_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK_CORE_FPGA_BOARD_exdes.ucf CLK_CORE_FPGA_BOARD_exdes

echo 'Running map'
map -timing -pr b CLK_CORE_FPGA_BOARD_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm CLK_CORE_FPGA_BOARD_exdes -w routed.ncd routed.vhd
cd ..
